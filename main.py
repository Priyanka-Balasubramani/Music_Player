...
animation_image = PhotoImage(file='aa1.gif')
...
Button(root, image=ButtonNext, bg="#FFFFFF", bd=0, height=60, width=60, command=NextMusic).place(x=350, y=487)

ButtonPrevious = PhotoImage(file="prev.png")
